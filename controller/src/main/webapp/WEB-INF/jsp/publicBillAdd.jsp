            ...
            <div class="logo_box2">
                <form class="layui-form layui-form-pane" action="/5/51/addPublicBill" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input name="bookName" lay-verify="required" placeholder="请输入图书名称" autocomplete="off" class="layui-input" type="text">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">出版社</label>
                        <div class="layui-input-inline">
                            <input name="publicer" lay-verify="required" placeholder="请输入出版社" autocomplete="off" class="layui-input" type="text">
                        </div>
                    </div>
