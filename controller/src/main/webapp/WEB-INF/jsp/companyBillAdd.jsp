        ...
        <div class="logo_box2">
            <form class="layui-form layui-form-pane" action="/5/51/addCompanyBill" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="phone" lay-verify="required" placeholder="请输入客户联系电话" autocomplete="off"
                               class="layui-input" type="text">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="customer" lay-verify="required" placeholder="请输入客户姓名" autocomplete="off"
                               class="layui-input" type="text">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="customerUnit" lay-verify="required" placeholder="请输入客户单位名称" autocomplete="off"
                               class="layui-input" type="text">
                    </div>
                </div>
                <div class="layui-form-item">
